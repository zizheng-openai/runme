...
func (BlockKind) Descriptor() protoreflect.EnumDescriptor {
	return file_agent_blocks_proto_enumTypes[0].Descriptor()
}

func (BlockKind) Type() protoreflect.EnumType {
	return &file_agent_blocks_proto_enumTypes[0]
}
...
func (BlockKind) EnumDescriptor() ([]byte, []int) {
	return file_agent_blocks_proto_rawDescGZIP(), []int{0}
}
...
func (BlockRole) Descriptor() protoreflect.EnumDescriptor {
	return file_agent_blocks_proto_enumTypes[1].Descriptor()
}

func (BlockRole) Type() protoreflect.EnumType {
	return &file_agent_blocks_proto_enumTypes[1]
}
...
func (BlockRole) EnumDescriptor() ([]byte, []int) {
	return file_agent_blocks_proto_rawDescGZIP(), []int{1}
}
...
func (BlockOutputKind) Descriptor() protoreflect.EnumDescriptor {
	return file_agent_blocks_proto_enumTypes[2].Descriptor()
}

func (BlockOutputKind) Type() protoreflect.EnumType {
	return &file_agent_blocks_proto_enumTypes[2]
}
...
func (BlockOutputKind) EnumDescriptor() ([]byte, []int) {
	return file_agent_blocks_proto_rawDescGZIP(), []int{2}
}
...
func (x *Block) Reset() {
	*x = Block{}
	mi := &file_agent_blocks_proto_msgTypes[0]
...
func (x *BlockOutput) Reset() {
	*x = BlockOutput{}
	mi := &file_agent_blocks_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *BlockOutputItem) Reset() {
	*x = BlockOutputItem{}
	mi := &file_agent_blocks_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *GenerateRequest) Reset() {
	*x = GenerateRequest{}
	mi := &file_agent_blocks_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GenerateRequest) Descriptor() ([]byte, []int) {
	return file_agent_blocks_proto_rawDescGZIP(), []int{3}
}
...
func (x *GenerateResponse) Reset() {
	*x = GenerateResponse{}
	mi := &file_agent_blocks_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GenerateResponse) Descriptor() ([]byte, []int) {
	return file_agent_blocks_proto_rawDescGZIP(), []int{4}
}
...
var File_agent_blocks_proto protoreflect.FileDescriptor

const file_agent_blocks_proto_rawDesc = "" +
	"\n" +
	"\x12agent/blocks.proto\x1a\x16agent/filesearch.proto\"\x82\x03\n" +
	"\x05Block\x12\x1e\n" +
	...
	"\x06STDERR\x10\x022D\n" +
	"\rBlocksService\x123\n" +
	"\bGenerate\x12\x10.GenerateRequest\x1a\x11.GenerateResponse\"\x000\x01B5Z3github.com/runmedev/runme/v3/api/gen/proto/go/agentb\x06proto3"

var (
	file_agent_blocks_proto_rawDescOnce sync.Once
	file_agent_blocks_proto_rawDescData []byte
)

func file_agent_blocks_proto_rawDescGZIP() []byte {
	file_agent_blocks_proto_rawDescOnce.Do(func() {
		file_agent_blocks_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_agent_blocks_proto_rawDesc), len(file_agent_blocks_proto_rawDesc)))
	})
	return file_agent_blocks_proto_rawDescData
}

var file_agent_blocks_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_agent_blocks_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_agent_blocks_proto_goTypes = []any{
...
var file_agent_blocks_proto_depIdxs = []int32{
...
func init() { file_agent_blocks_proto_init() }
func file_agent_blocks_proto_init() {
	if File_agent_blocks_proto != nil {
		return
	}
	file_agent_filesearch_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_agent_blocks_proto_rawDesc), len(file_agent_blocks_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_agent_blocks_proto_goTypes,
		DependencyIndexes: file_agent_blocks_proto_depIdxs,
		EnumInfos:         file_agent_blocks_proto_enumTypes,
		MessageInfos:      file_agent_blocks_proto_msgTypes,
	}.Build()
	File_agent_blocks_proto = out.File
	file_agent_blocks_proto_goTypes = nil
	file_agent_blocks_proto_depIdxs = nil
}
