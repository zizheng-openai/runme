...
declare class TransformRequest$Type extends MessageType<TransformRequest> {
    constructor();
    create(value?: PartialMessage<TransformRequest>): TransformRequest;
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TransformRequest): TransformRequest;
    internalBinaryWrite(message: TransformRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter;
}
/**
...
declare class TransformRequestExtension$Type extends MessageType<TransformRequestExtension> {
    constructor();
    create(value?: PartialMessage<TransformRequestExtension>): TransformRequestExtension;
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TransformRequestExtension): TransformRequestExtension;
    private binaryReadMap21;
    internalBinaryWrite(message: TransformRequestExtension, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter;
}
/**
...
declare class TransformResponse$Type extends MessageType<TransformResponse> {
    constructor();
    create(value?: PartialMessage<TransformResponse>): TransformResponse;
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TransformResponse): TransformResponse;
    internalBinaryWrite(message: TransformResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter;
}
/**
...
declare class ReporterExtension$Type extends MessageType<ReporterExtension> {
    constructor();
    create(value?: PartialMessage<ReporterExtension>): ReporterExtension;
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ReporterExtension): ReporterExtension;
    internalBinaryWrite(message: ReporterExtension, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter;
}
/**
...
declare class ReporterGit$Type extends MessageType<ReporterGit> {
    constructor();
    create(value?: PartialMessage<ReporterGit>): ReporterGit;
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ReporterGit): ReporterGit;
    internalBinaryWrite(message: ReporterGit, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter;
}
/**
...
declare class ReporterSession$Type extends MessageType<ReporterSession> {
    constructor();
    create(value?: PartialMessage<ReporterSession>): ReporterSession;
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ReporterSession): ReporterSession;
    internalBinaryWrite(message: ReporterSession, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter;
}
/**
...
declare class ReporterFile$Type extends MessageType<ReporterFile> {
    constructor();
    create(value?: PartialMessage<ReporterFile>): ReporterFile;
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ReporterFile): ReporterFile;
    internalBinaryWrite(message: ReporterFile, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter;
}
/**
...
declare class ReporterDevice$Type extends MessageType<ReporterDevice> {
    constructor();
    create(value?: PartialMessage<ReporterDevice>): ReporterDevice;
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ReporterDevice): ReporterDevice;
    private binaryReadMap12;
    internalBinaryWrite(message: ReporterDevice, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter;
}
/**
