...
(function (BlockKind) {
     ...
     */
    BlockKind[BlockKind["UNKNOWN_BLOCK_KIND"] = 0] = "UNKNOWN_BLOCK_KIND";
    /**
...
(function (BlockRole) {
     ...
     */
    BlockRole[BlockRole["UNKNOWN"] = 0] = "UNKNOWN";
    /**
...
(function (BlockOutputKind) {
     ...
     */
    BlockOutputKind[BlockOutputKind["UNKNOWN_BLOCK_OUTPUT_KIND"] = 0] = "UNKNOWN_BLOCK_OUTPUT_KIND";
    /**
...
class Block$Type extends MessageType {
    constructor() {
        super("Block", [
            { no: 1, name: "kind", kind: "enum", T: () => ["BlockKind", BlockKind] },
            ...
            { no: 9, name: "role", kind: "enum", T: () => ["BlockRole", BlockRole, "BLOCK_ROLE_"] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* map<string, string> metadata */ 8:
                    ...
                    break;
                case /* BlockRole role */ 9:
                    message.role = reader.int32();
                    break;
                case /* repeated FileSearchResult file_search_results */ 10:
                    message.fileSearchResults.push(FileSearchResult.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated BlockOutput outputs */ 11:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for Block.metadata");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
class BlockOutput$Type extends MessageType {
    constructor() {
        super("BlockOutput", [
            ...
            { no: 2, name: "kind", kind: "enum", T: () => ["BlockOutputKind", BlockOutputKind] }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
 ...
 */
export const BlocksService = new ServiceType("BlocksService", [
