 ...
 *
 * @generated from protobuf message agent.v1.Block
 */
export interface Block {
    /**
     * BlockKind is an enum indicating what type of block it is e.g text or output
     *
     * @generated from protobuf field: agent.v1.BlockKind kind = 1
     */
    kind: BlockKind;
    /**
    ...
    /**
     * @generated from protobuf field: agent.v1.BlockRole role = 9
     */
    role: BlockRole;
    /**
     * @generated from protobuf field: repeated agent.v1.FileSearchResult file_search_results = 10
     */
    fileSearchResults: FileSearchResult[];
    /**
     * @generated from protobuf field: repeated agent.v1.BlockOutput outputs = 11
     */
    outputs: BlockOutput[];
    /**
 ...
 *
 * @generated from protobuf message agent.v1.BlockOutput
 */
export interface BlockOutput {
    /**
     * items is the output items. Each item is the different representation of the same output data
     *
     * @generated from protobuf field: repeated agent.v1.BlockOutputItem items = 1
     */
    items: BlockOutputItem[];
    /**
     * @generated from protobuf field: agent.v1.BlockOutputKind kind = 2
     */
 ...
 *
 * @generated from protobuf message agent.v1.BlockOutputItem
 */
...
export interface GenerateRequest {
    /**
     * @generated from protobuf field: repeated agent.v1.Block blocks = 1
     */
    blocks: Block[];
    /**
