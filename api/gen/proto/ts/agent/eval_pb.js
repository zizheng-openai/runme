...
(function (Assertion_Type) {
     ...
     */
    Assertion_Type[Assertion_Type["UNKNOWN"] = 0] = "UNKNOWN";
    /**
...
(function (Assertion_Result) {
     ...
     */
    Assertion_Result[Assertion_Result["UNKNOWN"] = 0] = "UNKNOWN";
    /**
...
class Assertion$Type extends MessageType {
    constructor() {
        super("Assertion", [
            ...
            { no: 2, name: "type", kind: "enum", T: () => ["Assertion.Type", Assertion_Type, "TYPE_"], options: { "buf.validate.field": { required: true } } },
            { no: 3, name: "result", kind: "enum", T: () => ["Assertion.Result", Assertion_Result, "RESULT_"] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string name */ 1:
                    ...
                    break;
                case /* Assertion.Type type */ 2:
                    message.type = reader.int32();
                    break;
                case /* Assertion.Result result */ 3:
                    message.result = reader.int32();
                    break;
                case /* Assertion.ShellRequiredFlag shell_required_flag */ 4:
                    message.payload = {
                    ...
                    break;
                case /* Assertion.ToolInvocation tool_invocation */ 5:
                    message.payload = {
                    ...
                    break;
                case /* Assertion.FileRetrieval file_retrieval */ 6:
                    message.payload = {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* Assertion.Type type = 2; */
        if (message.type !== 0)
            writer.tag(2, WireType.Varint).int32(message.type);
        /* Assertion.Result result = 3; */
        if (message.result !== 0)
            writer.tag(3, WireType.Varint).int32(message.result);
        /* Assertion.ShellRequiredFlag shell_required_flag = 4; */
        ...
        /* Assertion.ToolInvocation tool_invocation = 5; */
        ...
        /* Assertion.FileRetrieval file_retrieval = 6; */
        ...
        /* Assertion.LLMJudge llm_judge = 7; */
        ...
        /* Assertion.CodeblockRegex codeblock_regex = 8; */
...
class Assertion_ShellRequiredFlag$Type extends MessageType {
    constructor() {
        super("Assertion.ShellRequiredFlag", [
...
class Assertion_ToolInvocation$Type extends MessageType {
    constructor() {
        super("Assertion.ToolInvocation", [
...
class Assertion_CodeblockRegex$Type extends MessageType {
    constructor() {
        super("Assertion.CodeblockRegex", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string input_text */ 3:
                    ...
                    break;
                case /* repeated Assertion assertions */ 4:
...
class EvalDataset$Type extends MessageType {
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated EvalSample samples */ 1:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string kind */ 2:
                    message.kind = reader.string();
                    break;
                case /* ObjectMeta metadata */ 3:
                    message.metadata = ObjectMeta.internalBinaryRead(reader, reader.uint32(), options, message.metadata);
                    break;
                case /* ExperimentSpec spec */ 4:
